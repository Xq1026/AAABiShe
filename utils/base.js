const base = {
	get() {
		return {
			url : "http://localhost:8080/xiaoyuan1rxvwvck/",
			name: "xiaoyuan1rxvwvck",
			// 退出到首页链接
			indexUrl: 'http://localhost:8080/xiaoyuan1rxvwvck/front/h5/index.html'
		};
	},
	getProjectName(){
		return {
			projectName: "基于微信小程序的校园闲置书籍共享系统"
		} 
	},
	getUsersName(){
		return {
