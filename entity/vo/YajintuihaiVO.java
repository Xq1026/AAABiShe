 ...
 */
public class YajintuihaiVO  implements Serializable {
	...
	public void setTuihaishijian(Date tuihaishijian) {
		this.tuihaishijian = tuihaishijian;
	}
	
	/**
	 * 获取：退还时间
	 */
	public Date getTuihaishijian() {
		return tuihaishijian;
	}
