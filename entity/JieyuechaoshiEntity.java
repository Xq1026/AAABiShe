...
public class JieyuechaoshiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public JieyuechaoshiEntity() {
		
	}
	
	public JieyuechaoshiEntity(T t) {
		try {
	 ...
	 * 设置：罚金比例
	 */
	public void setFajinbili(Double fajinbili) {
		this.fajinbili = fajinbili;
	}
	/**
	 * 获取：罚金比例
	 */
	public Double getFajinbili() {
		return fajinbili;
	}
	/**
	 * 设置：超时金额
