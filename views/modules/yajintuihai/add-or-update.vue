	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="date" v-if="type!='info'" label="退还时间" prop="tuihaishijian" >
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.tuihaishijian" 
						type="datetime"
						:readonly="ro.tuihaishijian"
						placeholder="退还时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item class="input" v-else-if="ruleForm.tuihaishijian" label="退还时间" prop="tuihaishijian" >
					<el-input v-model="ruleForm.tuihaishijian" placeholder="退还时间" readonly></el-input>
				</el-form-item>
