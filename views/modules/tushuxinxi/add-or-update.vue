		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="图书类型" prop="tushuleixing" >
					<el-select :disabled="ro.tushuleixing" v-model="ruleForm.tushuleixing" placeholder="请选择图书类型"  filterable>
						<el-option
				...
				<el-form-item class="input" v-if="type!='info'"  label="出版公司" prop="chubangongsi" >
					<el-input v-model="ruleForm.chubangongsi" placeholder="出版公司" clearable  :readonly="ro.chubangongsi"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="出版公司" prop="chubangongsi" >
					<el-input v-model="ruleForm.chubangongsi" placeholder="出版公司" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="图书标签" prop="tushubiaoqian" >
					<el-input v-model="ruleForm.tushubiaoqian" placeholder="图书标签" clearable  :readonly="ro.tushubiaoqian"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="图书标签" prop="tushubiaoqian" >
					<el-input v-model="ruleForm.tushubiaoqian" placeholder="图书标签" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="受众群体" prop="shouzhongqunti" >
					<el-input v-model="ruleForm.shouzhongqunti" placeholder="受众群体" clearable  :readonly="ro.shouzhongqunti"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="受众群体" prop="shouzhongqunti" >
					<el-input v-model="ruleForm.shouzhongqunti" placeholder="受众群体" readonly></el-input>
				</el-form-item>
				<el-form-item class="select" v-if="type!='info'"  label="图书状态" prop="tushuzhuangtai" >
					<el-select :disabled="ro.tushuzhuangtai" v-model="ruleForm.tushuzhuangtai" placeholder="请选择图书状态"  filterable>
						<el-option
				...
				<el-form-item v-else class="input" label="图书状态" prop="tushuzhuangtai" >
				...
				<el-form-item class="input" v-if="type!='info'"  label="借书地点" prop="jieshudidian" >
					<el-input v-model="ruleForm.jieshudidian" placeholder="借书地点" clearable  :readonly="ro.jieshudidian"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="借书地点" prop="jieshudidian" >
					<el-input v-model="ruleForm.jieshudidian" placeholder="借书地点" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="图书押金" prop="tushuyajin" >
					<el-input-number v-model="ruleForm.tushuyajin" placeholder="图书押金" :disabled="ro.tushuyajin"></el-input-number>
				</el-form-item>
			...
			<el-form-item v-else-if="ruleForm.tushujianjie" label="图书简介" prop="tushujianjie"  class="textBox">
				<span class="text">{{ruleForm.tushujianjie}}</span>
			</el-form-item>
			...
			init(id,type ) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='jieshudidian'){
							this.ruleForm.jieshudidian = obj[o];
							this.ro.jieshudidian = true;
							continue;
						}
						if(o=='tushuyajin'){
					...
					this.ruleForm.tushuzhuangtai = '未借出'; 				}
				// 获取用户信息
				this.$http({
