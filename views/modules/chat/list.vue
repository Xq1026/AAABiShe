<template>
	<div class="main-content" :style='{"padding":"22px 28px"}'>
		...
		<div v-if="!showFlag" style="width: 100%;">
			<el-form :style='{"padding":"0","margin":"0 0 0px","borderColor":"#fff","borderRadius":"32px 32px 0 0","background":"#f1f7fd","borderWidth":"1px 1px 0 1px","width":"100%","borderStyle":"solid"}' :inline="true" :model="searchForm" class="center-form-pv">
				<el-row :style='{"padding":"30px","borderRadius":"8px 8px 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative"}'>
					<div :style='{"margin":"0 1% 10px 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#333333","lineHeight":"40px","fontSize":"16px","fontWeight":"500","height":"40px"}' class="item-label">是否回复</label>
					...
					<div :style='{"margin":"0 1% 10px 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#333333","lineHeight":"40px","fontSize":"16px","fontWeight":"500","height":"40px"}' class="item-label">是否已读</label>
						<el-select v-model="searchForm.isread" placeholder="请选择">
							<el-option label="已读" :value="1"></el-option>
							<el-option label="未读" :value="0"></el-option>
						</el-select>
					</div>
					<el-button class="search" :style='{"border":"0","cursor":"pointer","padding":"0 10px 0 0px","outline":"none","color":"#fff","borderRadius":"24px","background":"#7987FD","width":"auto","fontSize":"16px","minWidth":"120px","fontWeight":"bold","height":"41px"}' type="success" @click="search()">
				...
				<el-table
					...
					<el-table-column
						...
						<template slot-scope="scope">
							<el-button
								type="text"
								:style='{"border":"1px solid #33993350","cursor":"pointer","padding":"0 10px","margin":"4px","color":"#339933","outline":"none","borderRadius":"6px","background":"#fff","width":"auto","fontSize":"14px","fontWeight":"400","height":"36px","order":"3"}'
								size="small"
