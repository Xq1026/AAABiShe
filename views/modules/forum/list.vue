	...
	<div class="main-content" :style='{"padding":"22px 28px"}'>
		...
		<template v-if="showFlag ">
			<el-form class="center-form-pv" :style='{"padding":"0","margin":"0 0 0px","borderColor":"#fff","borderRadius":"32px 32px 0 0","background":"#f1f7fd","borderWidth":"1px 1px 0 1px","width":"100%","borderStyle":"solid"}' :inline="true" :model="searchForm">
				<el-row :style='{"padding":"30px","borderRadius":"8px 8px 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative"}' v-if="!forumChild">
					<div  :style='{"margin":"0 1% 10px 0","display":"flex"}'>
						<label :style='{"margin":"0 10px 0 0","whiteSpace":"nowrap","color":"#333333","lineHeight":"40px","fontSize":"16px","fontWeight":"500","height":"40px"}' class="item-label">帖子标题</label>
				...
				<el-row :style='{"padding":"30px","borderRadius":"8px 8px 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative"}' v-if="forumChild">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px 0 0px","outline":"none","color":"#fff","borderRadius":"24px","background":"#7987FD","width":"auto","fontSize":"16px","minWidth":"120px","fontWeight":"bold","height":"41px"}' type="success" @click="search()">返回</el-button>
				</el-row>
