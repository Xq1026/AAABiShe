	...
	<view class="content">
		<view class="container" :style='{"minHeight":"100vh","width":"100%","padding":"0","position":"relative","background":"#fff","height":"auto"}'>
			...
			<view :style='{"alignContent":"flex-start","padding":"0","margin":"0 auto","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","height":"auto","zIndex":"9"}' class="detail-content">
				...
				<view class="detail-list-item" :style='{"padding":"0 20rpx","boxShadow":"none","margin":"10rpx","borderColor":"#ccc","borderRadius":"20rpx","borderWidth":"0 0 0px 0","background":"#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","whiteSpace":"nowrap","color":"#333","textAlign":"right","width":"auto","lineHeight":"80rpx","fontSize":"28rpx"}'>支付时间：</view>
					<view class="text" :style='{"padding":"0px","margin":"0px","lineHeight":"80rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}' >{{detail.zhifushijian}}</view>
				</view>
				<view class="detail-list-item" :style='{"padding":"0 20rpx","boxShadow":"none","margin":"10rpx","borderColor":"#ccc","borderRadius":"20rpx","borderWidth":"0 0 0px 0","background":"#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"padding":"0 24rpx","margin":"40rpx auto","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto","order":"20"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx","boxShadow":"none","margin":"0 10rpx 10rpx 0","color":"#174add","borderRadius":"8rpx","background":"#d3e5ff","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' @tap="onPayTap" v-if="userid&&isAuth('zhifuyajin','支付') && detail.ispay!='已支付'"  class="cu-btn bg-brown round shadow-blur">支付</button>
					<button :style='{"border":"0","padding":"0 20rpx","boxShadow":"none","margin":"0 10rpx 10rpx 0","color":"#174add","borderRadius":"8rpx","background":"#d3e5ff","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' @tap="onPayTap" v-if="!userid&&isAuthFront('zhifuyajin','支付') && detail.ispay!='已支付'"  class="cu-btn bg-brown round shadow-blur">支付</button>
					<button :style='{"border":"0","padding":"0 20rpx","boxShadow":"none","margin":"0 10rpx 10rpx 0","color":"#174add","borderRadius":"8rpx","background":"#d3e5ff","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' v-if="!isAuth('zhifuyajin','支付') && detail.ispay!='已支付'" class="cu-btn bg-brown round shadow-blur">未支付</button>
					...
					<button :style='{"border":"0","padding":"0 20rpx","boxShadow":"none","margin":"0 10rpx 10rpx 0","color":"#174add","borderRadius":"8rpx","background":"#d3e5ff","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' v-if="userid&&isAuth('zhifuyajin','阅读')" @tap="onAcrossTap('tushuyuedu','否','是','','')" class="cu-btn bg-brown round shadow-blur" >阅读</button>
					<button :style='{"border":"0","padding":"0 20rpx","boxShadow":"none","margin":"0 10rpx 10rpx 0","color":"#174add","borderRadius":"8rpx","background":"#d3e5ff","width":"auto","fontSize":"28rpx","lineHeight":"80rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('zhifuyajin','阅读')" @tap="onAcrossTap('tushuyuedu','否','是','','')" class="cu-btn bg-brown round shadow-blur" >阅读</button>
				</view>
			</view>
		</view>
	</view>
	...
	export default {
		...
		async onShow(options) {
			...
			if(crossCleanType) {
				...
				res = await this.$api.info('zhifuyajin', this.id);
		...
		methods: {
			...
			onPayTap(){
				...
				uni.setStorageSync('paytable','zhifuyajin');
			...
			async onAcrossTap(tableName,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue,type=1){
				...
				uni.setStorageSync('crossTable','zhifuyajin');
			...
			async init(type=1){
				...
				let res = await this.$api.info('zhifuyajin', this.id);
				let reg=new RegExp('http://localhost:8080/xiaoyuan1rxvwvck/upload','g')//g代表全部
				this.detail = res.data;
				...
				if(type==2){
					...
					await this.$api.update('zhifuyajin',this.detail)
				}
			},
