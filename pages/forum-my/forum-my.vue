<template>
	<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback" @scroll="scrollChange">
		...
		<view class="list" :style='{"padding":"60rpx 20rpx"}'>
			<view style="position: relative" v-for="(item,index) in list " v-bind:key="index" :style='{"border":"0px solid #ddd","padding":"30rpx","margin":"0 0 20rpx","borderRadius":"20rpx","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between"}'>
		...
		<!--list end-->
		<button :style='{"padding":"0 40rpx","margin":"40rpx auto 40rpx auto","color":"#fff","borderRadius":"60rpx","textAlign":"center","background":"#174add","width":"50%","lineHeight":"80rpx","height":"80rpx"}' @click="onUpdateTap()">新增</button>
