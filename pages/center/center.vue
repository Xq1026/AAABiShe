<template>
	<view class="content">
		<view :style='{"minHeight":"100vh","width":"100%","padding":"40rpx 0 0","position":"relative","background":"url(http://codegen.caihongy.cn/20250811/9b967684b4b14b0798885cba72ff0840.jpg) no-repeat center top / 100% auto,#ffffff","height":"auto"}'>
			<view v-if="user&&user.id" :style='{"minHeight":"auto","padding":"48rpx 24rpx 0","margin":"0 0 20rpx 0","borderRadius":"0","background":"none","display":"flex","width":"100%","position":"unset","height":"auto"}' @tap="onPageTap('../user-info/user-info')" class="header" v-bind:class="{'status':isH5Plus}">
				<view :style='{"width":"100%","position":"relative","flexWrap":"wrap","display":"flex","height":"auto"}' v-if="tableName=='yonghu'" class="userinfo">
					<image :style='{"width":"120rpx","padding":"0","margin":"0 10rpx 0 0","borderRadius":"100%","float":"left","height":"120rpx"}' :src="user.touxiang?baseUrl+user.touxiang:require('../../static/gen/upload.png')"></image>
					<view :style='{"width":"calc(100% - 130rpx)","flexDirection":"column","background":"none","justifyContent":"center","display":"flex"}' class="info">
						<view :style='{"width":"100%","padding":"0 40rpx 0 0","lineHeight":"48rpx","fontSize":"28rpx","color":"#333","textAlign":"left"}'>{{user.yonghuzhanghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
					
					<view :style='{"padding":"20rpx 40rpx","margin":"0px 0 0","color":"#fff","borderRadius":"20rpx","flexWrap":"wrap","background":"rgba(0,0,0,.5)","display":"flex","width":"100%","clear":"both","fontSize":"28rpx","justifyContent":"center","order":"5"}' class="info">
						<view :style='{"width":"auto","margin":"0 20rpx 0 0","lineHeight":"48rpx","fontSize":"inherit","display":"flex"}'>
							<span :style='{"color":"inherit","whiteSpace":"nowrap"}'>手机：</span>
							<span :style='{"color":"inherit"}'>{{user.shouji}}</span>
						</view>
						<view :style='{"width":"auto","lineHeight":"48rpx","fontSize":"inherit","display":"flex"}' v-if="user.jf||user.jf==0">
							<span :style='{"color":"inherit","whiteSpace":"nowrap"}'>积分：</span>
							<span :style='{"color":"inherit"}'>{{user.jf}}</span>
						</view>
					</view>
					<view :style='{"border":"0px solid #ffffff80","padding":"0px","margin":"30rpx 0","borderRadius":"20rpx","background":"rgba(255,255,255,0)","display":"flex","width":"100%"}'>
					  <view :style='{"border":"2rpx solid #ffffff","padding":"10rpx","margin":"0 20rpx 0 0","borderRadius":"40rpx","background":"rgba(255,255,255,.5)","display":"flex"}'>
