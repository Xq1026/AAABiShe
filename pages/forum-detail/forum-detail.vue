<template>
	<view :style='{"alignContent":"flex-start","width":"100%","padding":"0","flexWrap":"wrap","background":"#fff","display":"flex"}'>
		...
		<view :style='{"padding":"0 24rpx","margin":"0 auto","color":"#888","textAlign":"right","background":"#fff","width":"calc(100% - 0px)","fontSize":"28rpx"}'>
		...
		<view :style='{"border":"0px solid #eee","padding":"48rpx 24rpx","margin":"0 auto","borderRadius":"0 0 0px 0px","color":"#666","background":"#fff","width":"calc(100% - 0px)","fontSize":"30rpx","lineHeight":"48rpx"}'>
			<rich-text :nodes="forum.content"></rich-text>
		</view>
		<view :style='{"width":"calc(100% - 48rpx)","margin":"40rpx auto 168rpx","background":"none","order":"11"}'>
			<view :style='{"width":"100%","padding":"48rpx 24rpx 48rpx","margin":"0 0 40rpx","borderRadius":"0px","background":"url(http://codegen.caihongy.cn/20241112/02151c8c00094ff3acfeee72a96e907a.jpg) no-repeat center top / 100% 100%"}' v-for="comment in commentData" :key="comment.id">
				...
				<view :style='{"border":"0px solid #eee","padding":"0 20rpx 20rpx 100rpx","fontSize":"28rpx","color":"#333","background":"url(http://codegen.caihongy.cn/20241112/bbf67de82a1741b5aa6979d9a45fefbd.jpg) no-repeat center bottom / 100% auto"}'>
					...
					<view :style='{"width":"100%","alignItems":"center","justifyContent":"flex-end","display":"flex"}'>
						<text @tap="onReplyTap(comment.id)" :style='{"padding":"6rpx 20rpx","margin":"0 0px 0 0","color":"#fff","borderRadius":"4rpx","background":"#174add","order":"2"}'>回复</text>
